...
| aiagents.wiki | https://aiagents.wiki (independent agent index, 358 profiles) | /submit form — currently disabled "Coming Soon" mock (no POST); manual route = email contact@aiagents.wiki | ⛔ submit form non-functional 2026-09-26 |
| ClawSites | https://www.clawsites.com/category/community (agent community directory) | bot-facing skill.md; POST /api/submissions (category COMMUNITY, desc 10–140 chars, honeypot empty); human-reviewed before publish | ⚠️ submitted pending review 2026-09-26 (ref cmuhr6m8m00002yrv5d1qdt9l) |
| OpenAgora | https://openagora.cc (open A2A agent registry) | register form -> POST /api/agents (slug/name/url/desc/provider/capabilities/skills); Supabase-backed | ⛔ backend Supabase 522 outage 2026-09-26; retry POST slug:"agentbazaar" when DB recovers |
